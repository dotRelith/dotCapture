...
{
    public partial class dotCapture_ScreenCapture : Form
    {
        public static dotCapture_ScreenCapture instance;
        private ResourceManager resourceManager;
        private SettingMenu settingsMenu;

        // Dynamic controls declaration
        ...
        // Constructor
        public dotCapture_ScreenCapture()
        {
            instance = this;
            ...
            // If Language not supported turns back to English
        ...
        #region COMMON CODE
        // Preprocess images so they have a DPI of 300 so that Tesseract reads them better.
        ...
        // Calculates the capture region rectangle
        ...
        // Resizes the Icons
        private Image ResizeIcon(string path, int width, int height)
        {
        ...
        // Creates buttons for the capture menu
        private Button CreateButton(string text, string imageFileName, EventHandler clickEvent)
        {
            ...
            button.Image = ResizeIcon(imageFileName, 24, 24);
        ...
        private void InitializeExtraComponents()
        {
            trayIcon = new(){
                Text = "dotCapture",
                Icon = new Icon(Assembly.GetExecutingAssembly().GetManifestResourceStream("dotCaptureV2.icons.program_icon.ico")),
                Visible = true,
            ...
            playPauseButton.Image = ResizeIcon("dotCaptureV2.icons.play.png", 32, 32);
            synthesizer.StateChanged += (sender, e) =>
            {
                if (e.State == SynthesizerState.Speaking || e.State == SynthesizerState.Ready)
                    playPauseButton.Image = ResizeIcon("dotCaptureV2.icons.pause.png", 32, 32);
            ...
            textToSpeechButton = CreateButton(resourceManager.GetString("text.to.speech.button"), "dotCaptureV2.icons.text2speech.png", textToSpeechButton_Click);
            copyTextButton = CreateButton(resourceManager.GetString("copy.text.button"), "dotCaptureV2.icons.copytext.png", copyTextButton_Click);
            translateButton = CreateButton(resourceManager.GetString("translate.button"), "dotCaptureV2.icons.translate.png", translateButton_Click);
            saveButton = CreateButton(resourceManager.GetString("save.button"), "dotCaptureV2.icons.save.png", saveButton_Click);
            copyButton = CreateButton(resourceManager.GetString("copy.button"), "dotCaptureV2.icons.copy.png", copyButton_Click);
        }
        ...
        private void UpdateVisualsAndSettings()
        {
            ...
            if (supportedLanguages.ContainsKey(Settings.Default.InterfaceLanguage))
            {
                ...
                MessageBox.Show(localization.Culture.ToString());
        ...
        private void translateButton_Click(object sender, EventArgs e)
        {
            ...
            languagePanel.Location = new Point(
                croppedRectangle.X + (croppedRectangle.Width / 2 - languagePanel.Size.Width / 2),
                croppedRectangle.Y + (croppedRectangle.Height / 2 - languagePanel.Size.Height / 2));
        ...
        private string SendMicrosoftTranslatorRequest(string route, object[] body)
        {
            ...
            var resourceName = "dotCaptureV2.appsettings.json";
        ...
        private void DrawCaptureOverlay(object sender, PaintEventArgs e)
        {
            ...
            Debug.WriteLine($"start:{selectionBoxStartPoint} end:{selectionBoxEndPoint}");
            ...
            e.Graphics.FillRectangle(brush, Screen.PrimaryScreen.Bounds);
        }
        ...
        public void ExitScreenCapture()
        {
            if (this.Visible)
            {
                ...
                synthesizer.SpeakAsyncCancelAll();
                // removes text-to-speech red buttons
